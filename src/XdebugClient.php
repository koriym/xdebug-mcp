...
class XdebugClient
{
    public const GLOBAL_STATE_FILE = Constants::GLOBAL_STATE_FILE;
    public const DEFAULT_PORT = Constants::XDEBUG_DEBUG_PORT;
    public const DEFAULT_HOST = Constants::DEFAULT_HOST;
